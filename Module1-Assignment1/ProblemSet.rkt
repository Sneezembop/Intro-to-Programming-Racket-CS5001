...
; Notes:
; Include examples from next time.
; All lines should not exceed 80 characters.(-1 Marks)
; After finishing off the assignment, always remember to indent your code.

; Total: 37/38 Excellant :)
; No black lines 5/5
; Problem 1 - 6/6 (Frustum-Surface: Number, Number, Number -> Number
;                  frustum-surface it should be)
; Problem 2 - 6/6 
; Problem 3 - 7/7
; Problem 4 - 5/5
; Problem 5 - 5/5
; Problem 7 - 4/4 (You should have atleast 4 test cases,img1-width > img2-width
;             but img1-height > img1-height.
;; ##############################
;; PROBLEM 1
;; ##############################
...
#;(define (temp-tstyle a-tstyle)
    (... (text-style-name a-tstyle)
         ... (text-style-fontsize a-tstyle)
         ... (text-style-color a-tstyle)))
