...
;;> Total: 70/75
;;> for make-palindrom: what if the given string is a palindrome.
;;> In this case you would only need to return the string as is.

;;> Try to use abstract functions for local definitions as well
;;> is-palidrome: you just need to reverse the string and compare
;;> it with the given string to check if it a palindrome.
;;> your method does not work for strings having a length which is an odd number
;;> reason: (substring astr 0 (/ (string-length astr) 2)
